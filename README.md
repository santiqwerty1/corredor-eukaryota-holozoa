...
**Estado:** provisional. Las secciones 13 y 15 final siguen pendientes.
...
## Estado científico pendiente

La lista operativa está en [`docs/STATUS.md`](docs/STATUS.md). Las instrucciones de publicación están en [`docs/GITHUB_SETUP.md`](docs/GITHUB_SETUP.md). La migración de Markdown a CSV no implica que los huecos científicos hayan quedado resueltos.
